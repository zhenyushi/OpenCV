...
int main(int argc, char **argv)
{
  ...
  //cv::moveWindow("view");      // move the window to the VIVE monitor, which is the second moniter on the right side of main monitor, and main monitor has a width of 1920
  //cv::setWindowProperty("view");  // setWindowProperty(window name, type of window property(full screen = 0), value of window property(full screen = 1))
